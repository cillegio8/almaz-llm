...
function TypingIndicator() {
  return (
    <div className="flex items-center gap-2">
      <div className="w-7 h-7 bg-accent-600 rounded-full flex items-center justify-center flex-shrink-0">
  ...
  if (messages.length === 0 && !sending) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center py-12 space-y-4">
        ...
        <div>
          <p className="font-medium text-gray-700">Salam! Sizə necə kömək edə bilərəm?</p>
          <p className="text-sm text-gray-400 mt-1">Azərbaycan dilində sualınızı yazın</p>
        </div>
      </div>
    )
  }
